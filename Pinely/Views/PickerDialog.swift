...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    func show(title: String, doneButtonTitle: String = "Rechazar",
              cancelButtonTitle: String = "Cancelar",
              options: [[String: String]], selected: String? = nil,
        ...
        NotificationCenter.default.addObserver(
            self, selector: #selector(deviceOrientationDidChange(notification:)),
    ...
    private func createContainerView() -> UIView {
        ...
        let lineView = UIView(frame: CGRect(
            ...
            width: dialogContainer.bounds.size.width, height: kPickerDialogDefaultButtonSpacerHeight))
        lineView.backgroundColor = UIColor(red: 198/255, green: 198/255, blue: 198/255, alpha: 1)
        dialogContainer.addSubview(lineView)
        // ˆˆˆ

        // Title
        self.titleLabel = UILabel(frame: CGRect(x: 10, y: 30, width: 280, height: 30))
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.doneButton.setTitleColor(UIColor.red /* UIColor(hex: 0x555555) */, for: UIControl.State.normal)
        self.doneButton.setTitleColor(UIColor.red /* UIColor(hex: 0x555555) */, for: UIControl.State.highlighted)
