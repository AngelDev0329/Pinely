...
/*!
 ...
 @remarks: Starting version 3.6.4. this protocol method is also used to return barcode data decoded using CR4400/CR4405 sled's engine. When decoding using sled engine this API would always return CD_SymbologyType_Undefined as its Symbology Type.
...
/*!
@brief Protocol method that is called to indicate if SDK was successful or not in decoding a barcode for each frame.

@param status Boolean value representing success or fail. YES indicates success and No indicates fail.

@since version 3.6.1
*/
@optional
-(void)receivedBarcodeDecodeStatus:(BOOL)status;
...
/*!
 ...
 @since version 3.4
 */
-(void)enableRobustMode:(BOOL)enable __attribute__ ((deprecated("This API was deprecated with CortexDecoderLibrary version 3.6.6. Use API setCustomMode: with CD_CustomModeShortRange attribute instead.")));;
 ...
 */
typedef enum{
    CD_DataParsing_Disable = 0,
    CD_DataParsing_DLParsing = 1,
    CD_DataParsing_StrMatchReplace = 4,
    CD_DataParsing_GS1Parsing = 5,
    CD_DataParsing_UDIParsing = 6,
    CD_DataParsing_ISOParsing = 7,
    CD_DataParsing_JSONDLParsing = 2
} CD_DataParsingType;
...
/*!
 @brief This method is used to pass raw configuration string.
 
 @discussion Raw configuration string is used to set Symbology or Performance setting.
 
 @param rawConfigurationString String in specific format that is used to set Symbology or Performance setting.
 
 @remarks Contact Code Support to learn more about this or on how to get raw configuration string for your use.
 
 @remarks This is an alternative to scanning QR Configuration Code which provides the same functionality.
 
 @remarks Make sure that raw configuration string passed to SDK is not tampered with. SDK rejects any invalid part of string without throwing an error.
 
 @since 3.6.0
 */
-(BOOL)setConfigurationString:(NSString*)rawConfigurationString;
...
/*!
 @brief This method retrieves license expiration date in NSDate format.
 
 @discussion Method returns expiration date for both Standard and Enterprise version of SDK.
 
 @return NSDate containing license expiration date and time or nil incase called before activating a licensing.
 
 @remarks Method will return an expiration date only if a license has been activated. In case when called before activaing license date object will be nil .
 @remarks For Standard SDK, Time returned right now has a bug. Actual expiration will be 23:59 PM but API returns inaccurate time right now.
 
 @since 3.6.1
 */
-(NSDate*)getLicenseExpirationDate;
...
/*!
@brief This method is used to get Case Hardware Number for connected Code Accessory.

@discussion Provides Case Hardware Number of current Code case attached to device.

@return NSString Contains String value indicating Case Hardware Number.

@since version 3.6.4
*/
-(NSString*)getSledAccessoryHardwareNumber;

/*!
@brief This method is used to get Case Manufacturer Name for connected Code Accessory.

@discussion Provides Case Manufacturer Name of current Code case attached to device.

@return NSString Contains String value indicating Case Manufacturer Name.

@since version 3.6.4
*/
-(NSString*)getSledAccessoryManufacturer;

#pragma mark - Codewords APIs

/*!
 @brief This method is used to enable/disable codewords output for Data Matrix and QR Code symbologies.
 
 @discussion When enabled Decoder can share codewords output for the decoded Data Matrix/QR Code symbology.
 
 @param enable Boolean parameter to enable or disable the feature. Default value is NO.

 @remarks Only supported for Data Matrix and QR Code symbologies.
   
 @see getNumberOfCodewords
 @see getNumberOfShortCodewordsBlocks
 @see getNumberOfLongCodewordsBlocks
 @see getNumberOfDataCodewords
 @see getNumberOfErrorCodewords
 @see getCodewordBeforeErrorCorrection
 @see getCodewordAfterErrorCorrection
 
 @since version 3.5.0
 */
-(void)enableCodewordsOutput:(BOOL)enable;

/*!
@brief This method returns integer value providing size of EccBefore and EccAfter.

@return int Integer value representating size of EccBefore and EccAfter. Default value is 0, meaning no data.

@remarks Only supported for Data Matrix and QR Code symbologies.
   
@see enableCodewordsOutput:
@see getNumberOfShortCodewordsBlocks
@see getNumberOfLongCodewordsBlocks
@see getNumberOfDataCodewords
@see getNumberOfErrorCodewords
...
@since version 3.5.0
*/
-(int)getNumberOfCodewords;

/*!
@brief This method returns integer value providing number of short codewords block.

@return int Integer value representating number of short codewords block. Default value is 0, meaning no data.
...
@since version 3.5.0
*/
-(int)getNumberOfShortCodewordsBlocks;

/*!
@brief This method returns integer value providing number of long codewords block.

@return int Integer value representating number of long codewords block. Default value is 0, meaning no data.
...
@since version 3.5.0
*/
-(int)getNumberOfLongCodewordsBlocks;

/*!
@brief This method returns integer value providing number of data codewords block.

@return int Integer value representating number of data codewords block. Default value is 0, meaning no data.
...
@since version 3.5.0
*/
-(int)getNumberOfDataCodewords;

/*!
@brief This method returns integer value providing number of error codewords block.

@return int Integer value representating number of error codewords block. Default value is 0, meaning no data.
...
@since version 3.5.0
*/
-(int)getNumberOfErrorCodewords;

/*!
@brief This method returns NSData providing raw bytes of codewords before error correction.

@return NSData Raw information for barcode codewords before error correction.
...
@since version 3.5.0
*/
-(NSData*)getCodewordBeforeErrorCorrection;

/*!
@brief This method returns NSData providing raw bytes of codewords after error correction.

@return NSData Raw information for barcode codewords after error correction.

@remarks Only supported for Data Matrix and QR Code symbologies.
@remarks If there is no error correction both
...
@since version 3.5.0
*/
-(NSData*)getCodewordAfterErrorCorrection;
...
/*!
 @brief This method returns an array of integer values that provide decode time for each barcode.
 
 @discussion Method return decode time for 1 or more barcodes. When decoding more than 1 barcode, decode time for successive barcodes includes decode time for previous barcodes as well.
                Total values in array is always 1 more than number of barcodes decoded, this last value in array is the total time it took to decode all the barcodes. When decoding a barcode with exact match feature (API matchDecodeCountExactly:) disabled, the last value includes time CortexDecoder took to search for additional barcode after last barcode it decoded.
 
 @remarks Feature not supported when MultiFrame decoding is used. API will send erroneous data when called when enableMultiFrameDecoding is enabled.
 
 @since version 3.6.1
 */
-(NSArray*)getDecodeTime;

/*!
@brief Provides a way to set duplicate delay time for barcodes. CortexDecoder will stop decoding barcodes with same data for the duration set,

@param delayTime Delay duration in milliseconds. Default setting is 0, that is, no delay.

@remarks Feature is only supported when decoding 1 barcode at a time. Not supported when multi frame decoding is enabled.

@since version 3.6.6
*/
-(void)setDuplicateDelay:(CGFloat)delayTime;

/*!
 @enum CD_CustomMode
 
 @field CD_CustomModeDisable        Default, Disable custom mode
 
 @field CD_CustomModeShortRange        Improves 2D barcode decoding when in short range from device camera
 ...
 */
typedef enum {
    CD_CustomModeDisable,
    CD_CustomModeShortRange
} CD_CustomMode;

/*!
 @brief This method is used to select a Custom Mode option. Defaults to CD_CustomModeDisable.
 
 @param mode Indicate to CortexDecoder custom mode type to be used.
 
 @see CD_CustomMode
 
 @since version 3.6.6
 */
-(void)setCustomMode:(CD_CustomMode)mode;

/*!
 @enum CD_PreprocessType
 
 @field CD_PreProcDisable        Default, Disable Preprocess
 
 @field CD_PreProcLowPass2      low pass filtering method 2 applied to the decimated image used when customMode is enabled
 
 @field CD_PreProcDeblur1dMethod1       image deblur filter method 1 to help decode blurry image of 1D barcodes such as Code 128, Code 39, I 2 of 5, UPC-A, UPC-E, EAN-13, EAN8.
 
 @see setPreprocessType:
 
 @since version 3.6.6
 */
typedef enum {
    CD_PreProcDisable = 0,
    CD_PreProcLowPass2 = 2,
    CD_PreProcDeblur1dMethod1 = 5,
} CD_PreprocessType;

/*!
 @brief This method is used to select a Preprocess option. Defaults to CD_PreProcDisable.
 
 @param type Indicate to CortexDecoder preprocess type to be used.
 
 @see CD_PreprocessType
 
 @since version 3.6.6
 */
-(void)setPreprocessType:(CD_PreprocessType)type;
